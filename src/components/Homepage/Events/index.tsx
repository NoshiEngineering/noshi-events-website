...
const eventTypes = [
  ...
  },
  {
    ...
    description:
      "We craft personalized weddings, anniversaries, and celebrations with elegance and attention to detail, creating heartfelt experiences that reflect ...",
    image: "/events/personal-event.svg",
  },
  {
    heading: "Sports Events",
    description:
      "We organize dynamic sports events, handling logistics and live coordination. Noshi Events ensures seamless experiences for athletes and audiences...",
    image: "/events/sports-event.svg",
  },
  {
    heading: "Promotional Events",
    description:
      "We bring brands to life with creative, engaging promotional events. From product launches to activations, Noshi Events delivers impactful...",
